#ifdef INTERFACE
CLASS(NewMenuMutatorsDialog) EXTENDS(NewMenuDialog)
	METHOD(NewMenuMutatorsDialog, toString, string(entity))
	METHOD(NewMenuMutatorsDialog, fill, void(entity))
	METHOD(NewMenuMutatorsDialog, showNotify, void(entity))
	METHOD(NewMenuMutatorsDialog, close, void(entity))
	ATTRIB(NewMenuMutatorsDialog, title, string, "Mutators")
	ATTRIB(NewMenuMutatorsDialog, color, vector, SKINCOLOR_DIALOG_MUTATORS)
	ATTRIB(NewMenuMutatorsDialog, intendedWidth, float, 0.9)
	ATTRIB(NewMenuMutatorsDialog, rows, float, 18)
	ATTRIB(NewMenuMutatorsDialog, columns, float, 6)
	ATTRIB(NewMenuMutatorsDialog, refilterEntity, entity, NULL)
ENDCLASS(NewMenuMutatorsDialog)
#endif

#ifdef IMPLEMENTATION
void showNotifyNewMenuMutatorsDialog(entity me)
{
	loadAllCvars(me);
}
...
string toStringNewMenuMutatorsDialog(entity me)
{
	string s;
	s = "";
	if(CVAR(g_minstagib))
...
void fillNewMenuMutatorsDialog(entity me)
{
	entity e, s, w;
	float i, j;
	string str, hstr;
	me.TR(me);
		me.TD(me, 1, 2, makeNewMenuTextLabel(0, "Gameplay mutators:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_cloaked", "Cloaked"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_footsteps", "Footsteps"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_midair", "Midair"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_vampire", "Vampire"));
	me.TR(me);
		me.TDempty(me, 0.2);
		s = makeNewMenuSlider(10, 50, 1, "g_bloodloss");
		me.TD(me, 1, 2, e = makeNewMenuSliderCheckBox(0, 1, s, "Blood loss"));
	me.TR(me);
		me.TDempty(me, 0.4);
		me.TD(me, 1, 1.8, s);
	me.TR(me);
		me.TDempty(me, 0.2);
		s = makeNewMenuSlider(80, 400, 8, "sv_gravity");
			s.valueDigits = 0;
			s.valueDisplayMultiplier = 0.125; // show gravity in percent
		me.TD(me, 1, 2, e = makeNewMenuSliderCheckBox(800, 1, s, "Low gravity"));
	...
	me.TR(me);
	me.TR(me);
		me.TD(me, 1, 2, makeNewMenuTextLabel(0, "Weapon & item mutators:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_grappling_hook", "Grappling hook"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_jetpack", "Jet pack"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_laserguided_missile", "Laser guided missiles"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBox(0, "g_pinata", "Pinata"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuCheckBoxEx(2, 0, "g_weapon_stay", "Weapons stay"));
	me.TR(me);

	me.gotoRC(me, 0, 2); me.setFirstColumn(me, me.currentColumn);
		me.TD(me, 1, 4, makeNewMenuTextLabel(0, "Weapon arenas:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, string_null, string_null, "Regular (no arena)"));
	for(i = WEP_FIRST, j = 0; i <= WEP_LAST; ++i)
	{
		...
		hstr = w.message;
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, "g_weaponarena", strzone(str), strzone(hstr)));
			e.cvarOffValue = "0";
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 1, e = makeNewMenuCheckBox(0, "menu_weaponarena_with_laser", "with laser"));
	...
	me.TR(me);
		me.TD(me, 1, 4, makeNewMenuTextLabel(0, "Special arenas:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, "g_minstagib", string_null, "MinstaGib"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, "g_nixnex", string_null, "NixNex"));
	me.TR(me);
		me.TDempty(me, 0.4);
		me.TD(me, 1, 1, e = makeNewMenuCheckBox(0, "g_nixnex_with_laser", "with laser"));
			setDependent(e, "g_nixnex", 1, 1);
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, "g_weaponarena", "most", "Most weapons"));
			e.cvarOffValue = "0";
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNewMenuRadioButton(1, "g_start_weapon_laser", "0", "No start weapons"));
			e.cvarOffValue = "-1";
...
void closeNewMenuMutatorsDialog(entity me)
{
