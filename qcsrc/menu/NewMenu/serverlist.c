#ifdef INTERFACE
CLASS(NewMenuServerList) EXTENDS(NewMenuListBox)
	METHOD(NewMenuServerList, configureNewMenuServerList, void(entity))
	ATTRIB(NewMenuServerList, rowsPerItem, float, 1)
	METHOD(NewMenuServerList, draw, void(entity))
	METHOD(NewMenuServerList, drawListBoxItem, void(entity, float, vector, float))
	METHOD(NewMenuServerList, clickListBoxItem, void(entity, float, vector))
	METHOD(NewMenuServerList, resizeNotify, void(entity, vector, vector, vector, vector))
	METHOD(NewMenuServerList, keyDown, float(entity, float, float, float))

	ATTRIB(NewMenuServerList, realFontSize, vector, '0 0 0')
	ATTRIB(NewMenuServerList, realUpperMargin, float, 0)
	ATTRIB(NewMenuServerList, columnPingOrigin, float, 0)
	ATTRIB(NewMenuServerList, columnPingSize, float, 0)
	ATTRIB(NewMenuServerList, columnNameOrigin, float, 0)
	ATTRIB(NewMenuServerList, columnNameSize, float, 0)
	ATTRIB(NewMenuServerList, columnMapOrigin, float, 0)
	ATTRIB(NewMenuServerList, columnMapSize, float, 0)
	ATTRIB(NewMenuServerList, columnTypeOrigin, float, 0)
	ATTRIB(NewMenuServerList, columnTypeSize, float, 0)
	ATTRIB(NewMenuServerList, columnPlayersOrigin, float, 0)
	ATTRIB(NewMenuServerList, columnPlayersSize, float, 0)

	ATTRIB(NewMenuServerList, selectedServer, string, string_null) // to restore selected server when needed
	METHOD(NewMenuServerList, setSelected, void(entity, float))
	METHOD(NewMenuServerList, setSortOrder, void(entity, float, float))
	ATTRIB(NewMenuServerList, filterShowEmpty, float, 1)
	ATTRIB(NewMenuServerList, filterShowFull, float, 1)
    ATTRIB(NewMenuServerList, filterShowOnlyRM, float, 0)
    ATTRIB(NewMenuServerList, filterShowOnlyEx, float, 0)
	ATTRIB(NewMenuServerList, filterString, string, string_null)
	ATTRIB(NewMenuServerList, controlledTextbox, entity, NULL)
	ATTRIB(NewMenuServerList, ipAddressBox, entity, NULL)
	ATTRIB(NewMenuServerList, favoriteButton, entity, NULL)
	ATTRIB(NewMenuServerList, nextRefreshTime, float, 0)
	METHOD(NewMenuServerList, refreshServerList, void(entity, float)) // refresh mode: 0 = just reparametrize, 1 = send new requests, 2 = clear
	ATTRIB(NewMenuServerList, needsRefresh, float, 1)
	METHOD(NewMenuServerList, focusEnter, void(entity))
	METHOD(NewMenuServerList, positionSortButton, void(entity, entity, float, float, string, void(entity, entity)))
	ATTRIB(NewMenuServerList, sortButton1, entity, NULL)
	ATTRIB(NewMenuServerList, sortButton2, entity, NULL)
	ATTRIB(NewMenuServerList, sortButton3, entity, NULL)
	ATTRIB(NewMenuServerList, sortButton4, entity, NULL)
	ATTRIB(NewMenuServerList, sortButton5, entity, NULL)
	ATTRIB(NewMenuServerList, connectButton, entity, NULL)
	ATTRIB(NewMenuServerList, infoButton, entity, NULL)
	ATTRIB(NewMenuServerList, currentSortOrder, float, 0)
...
{
	entity me;
	me = spawnNewMenuServerList();
	me.configureNewMenuServerList(me);
	return me;
}
void configureNewMenuServerListNewMenuServerList(entity me)
{
...
void setSelectedNewMenuServerList(entity me, float i)
{
	float save;
...
void refreshServerListNewMenuServerList(entity me, float mode)
{
...
void focusEnterNewMenuServerList(entity me)
{
...
void drawNewMenuServerList(entity me)
{
	float i, found, owned;
...
void setSortOrderNewMenuServerList(entity me, float field, float direction)
{
...
void positionSortButtonNewMenuServerList(entity me, entity btn, float theOrigin, float theSize, string theTitle, void(entity, entity) theFunc)
{
...
void resizeNotifyNewMenuServerList(entity me, vector relOrigin, vector relSize, vector absOrigin, vector absSize)
{
...
void clickListBoxItemNewMenuServerList(entity me, float i, vector where)
{
...
float keyDownNewMenuServerList(entity me, float scan, float ascii, float shift)
{
	float i;
	vector org, sz;
