...
void drawListBoxItemNexuizPlayerList(entity me, float i, vector absSize, float isSelected)
{
	...
	s = draw_TextShortenToWidth(s, (me.columnNameSize / me.realFontSize_x), 1, me.fontXYSize);
	score = draw_TextShortenToWidth(score, me.columnScoreSize / me.realFontSize_x, 0, me.fontXYSize);

	draw_Text(me.realUpperMargin2 * eY + (me.columnNameOrigin + 0.00 * (me.columnNameSize - draw_TextWidth(s, 1, me.fontXYSize) * me.realFontSize_x)) * eX, s, me.realFontSize, '1 1 1', 1, 1);
	draw_Text(me.realUpperMargin2 * eY + (me.columnScoreOrigin + 1.00 * (me.columnScoreSize - draw_TextWidth(score, 1, me.fontXYSize) * me.realFontSize_x)) * eX, score, me.realFontSize, rgb, 1, 0);
}
