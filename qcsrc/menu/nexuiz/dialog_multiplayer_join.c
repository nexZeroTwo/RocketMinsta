...
void fillNexuizServerListTab(entity me)
{
	...
	me.TR(me);
		...
		me.TD(me, 1, me.columns - 3.35, e = makeNexuizInputBox(0, string_null));
		...
		me.TD(me, 1, 0.35, e = makeNexuizCheckBox(0, "menu_slist_showonlyrm", "RM"));
			slist.filterShowEmpty = e.checked;
			e.onClickEntity = slist;
			e.onClick = ServerList_ShowOnlyRM_Click;
		me.TD(me, 1, 0.55, e = makeNexuizCheckBox(0, "menu_slist_showempty", "Empty"));
			slist.filterShowEmpty = e.checked;
			e.onClickEntity = slist;
			e.onClick = ServerList_ShowEmpty_Click;
		me.TD(me, 1, 0.45, e = makeNexuizCheckBox(0, "menu_slist_showfull", "Full"));
