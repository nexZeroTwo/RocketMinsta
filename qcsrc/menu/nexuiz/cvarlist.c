...
void drawListBoxItemNexuizCvarList(entity me, float i, vector absSize, float isSelected)
{
	...
	s = draw_TextShortenToWidth(k, me.columnNameSize / me.realFontSize_x, 0, me.fontXYSize);
	draw_Text(me.realUpperMargin * eY + me.columnNameOrigin * eX, s, me.realFontSize, theColor, theAlpha, 0);
	s = draw_TextShortenToWidth(v, me.columnValueSize / me.realFontSize_x, 0, me.fontXYSize);
