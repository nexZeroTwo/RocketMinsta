...
void drawListBoxItemNexuizKeyBinder(entity me, float i, vector absSize, float isSelected)
{
	...
	if(func != "")
	{
		...
		s = draw_TextShortenToWidth(s, me.columnKeysSize / me.realFontSize_x, 0, me.fontXYSize);
		draw_CenterText(me.realUpperMargin * eY + (me.columnKeysOrigin + 0.5 * me.columnKeysSize) * eX, s, me.realFontSize, theColor, theAlpha, 0, me.fontXYSize);
	}
}
#endif
